...
export default function AssetFormModal({ initialAsset, onClose, onSubmit, submitting }) {
  ...
  function handleSubmit(e) {
    ...
    // Send simplified asset details (let backend/system assign default baseline metrics)
    onSubmit({
      ...initialAsset,
      name: form.name.trim(),
      type: form.type,
...
const iconBtnStyle = { background: 'none', border: 'none', padding: 4, display: 'flex', cursor: 'pointer' };
const inputStyle = {
