...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { key: 'incidents', label: 'Incidents', icon: ShieldAlert, enabled: true },
      { key: 'vulnerabilities', label: 'Vulnerabilities', icon: Bug, enabled: true },
      { key: 'audit', label: 'Audit logs', icon: ScrollText, enabled: true },
      { key: 'compliance', label: 'Compliance', icon: ShieldCheck, enabled: true },
    ],
  },
  {
    ...
    items: [
      ...
      { key: 'reports', label: 'Reports', icon: BarChart3, enabled: true },
    ],
  },
];
